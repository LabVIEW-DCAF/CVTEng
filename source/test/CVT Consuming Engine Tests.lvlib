...
<Library LVVersion="13008000">
	...
	<Item Name="cfg serialize test.vi" Type="VI" URL="../cfg serialize test.vi"/>
	<Item Name="check config property nodes.vi" Type="VI" URL="../check config property nodes.vi"/>
	<Item Name="check editor prop nodes.vi" Type="VI" URL="../check editor prop nodes.vi"/>
</Library>
